...
var CouponService = /** @class */ (function () {
    ...
    CouponService.prototype.getCurAddr = function () {
        var _this = this;
    ...
    CouponService.prototype.shipOrder = function (orderId, email) {
        var _this = this;
        this.neb.setRequest(new __WEBPACK_IMPORTED_MODULE_4_nebulas__["HttpRequest"](__WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].http_request_url));
        var that = this, value = "0", callFunction = "shipOrder", callArgs = JSON.stringify([orderId, "优惠券信息已经发送至邮箱" + email + "，请查收"]), obs = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */](function (observer) {
            _this.nebPay.call(_this.dAppAddress, value, callFunction, callArgs, {
                listener: function (res) {
                    if (typeof (res) === 'string' && (res.indexOf("Error") != -1)) {
                        observer.error(res);
...
var MineComponent = /** @class */ (function () {
    ...
    MineComponent.prototype.ngOnInit = function () {
        ...
        this.sellerGetAllOrders();
        this.couponService.getCurAddr().subscribe(function (value) {
            _this.curAddr = value;
        });
    };
    ...
    MineComponent.prototype.shipOrder = function (orderId, email, event) {
        var _this = this;
        var ele = $(event.target);
        ele.addClass("loading");
        this.couponService.shipOrder(orderId, email).subscribe(function (value) {
        }, function (error) {
            _this.notify.show(error);
            ele.removeClass("loading");
        }, function () {
    ...
    MineComponent.prototype.receiveOrder = function (orderId, event) {
        var _this = this;
        var ele = $(event.target);
        ele.addClass("loading");
    ...
    MineComponent.prototype.sellerWithDraw = function (event) {
        var _this = this;
        var ele = $(event.target);
        ele.addClass("loading");
...
var environment = {
    ...
    dAppAddress: 'n1zTxXKqyFSHrF3sUtWBbTXyczNEdGEV7oo'
};
